...
void Network::init( void ) {
  ...
  dispOled.print( "IP : " ); dispOled.println( Ethernet.localIP() );
  dispOled.print( "GW : " ); dispOled.println( Ethernet.gatewayIP() );
  dispOled.print( "SM : " ); dispOled.println( Ethernet.subnetMask() );
  dispOled.print( "DNS: " ); dispOled.println( Ethernet.dnsServerIP() );
  dispOled.print( "NTP: " ); dispOled.println( String( _ntp ) );
  dispOled.display();

  u8g2.setFont(  u8g2_font_helvB18_tf );
  u8g2.setCursor( 0, u8g2.getCursorY()+30 );
  u8g2.setForegroundColor( ILI9341_CYAN  );
  u8g2.print( "IP : " ); u8g2.println( Ethernet.localIP() );
  u8g2.print( "GW : " ); u8g2.println( Ethernet.gatewayIP() );
  u8g2.print( "SM : " ); u8g2.println( Ethernet.subnetMask() );
  u8g2.print( "DNS: " ); u8g2.println( Ethernet.dnsServerIP() );
  u8g2.print( "NTP: " ); u8g2.println( String( _ntp ) );
